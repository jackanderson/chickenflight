...
#define PG_MIXER_CONFIG 20 // Cleanflight has single struct mixerConfig_t, chickenflight has mixerConfig_t and servoMixerConfig_t
#define PG_SERVO_MIXER 21 // Cleanflight has servoParam_t for each servo, chickenflight has single servoParam_t
#define PG_IMU_CONFIG 22 // Cleanflight has imuConfig_t, chickenflight has imuRuntimeConfig_t with additional parameters
#define PG_PROFILE_SELECTION 23 // just contains current_profile_index
#define PG_RX_CONFIG 24 // chickenflight rxConfig_t contains different values
#define PG_RC_CONTROLS_CONFIG 25 // Cleanflight has more parameters in rcControlsConfig_t
#define PG_MOTOR_3D_CONFIG 26 // Cleanflight has motor3DConfig_t, chickenflight has flight3DConfig_t with more parameters
...
#define PG_TELEMETRY_CONFIG 31 // chickenflight has more and different data in telemetryConfig_t
...
#define PG_ACCELEROMETER_CONFIG 35 // no accelerometerConfig_t in chickenflight
#define PG_RATE_PROFILE_SELECTION 36 // part of profile in chickenflight
...
#define PG_PILOT_CONFIG 47 // does not exist in chickenflight
#define PG_MSP_SERVER_CONFIG 48 // does not exist in chickenflight
...
#define PG_DEBUG_CONFIG 51 // does not exist in chickenflight
...
#define PG_DRIVER_PWM_RX_CONFIG 100 // does not exist in chickenflight
#define PG_DRIVER_FLASHCHIP_CONFIG 101 // does not exist in chickenflight
...
// chickenflight specific parameter group ids start at 500
